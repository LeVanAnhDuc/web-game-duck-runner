...
| 14 | **Luật hai lớp:** vật thể phải đọc nhanh có **thân tối + cạnh sáng**, và hai lớp nằm hai phía của nền về độ sáng. Xu đảo lại: thân sáng + vòng tối | Vật thể biến mất trên một loại nền và chỉ một loại. Đúng lỗi đã xảy ra: chướng ngại đọc rõ trên trời (9.14:1) và vô hình trên mặt đường (1.16:1). Không test luật chơi nào bắt được — `tests/render/contrast.test.ts` mới bắt |
